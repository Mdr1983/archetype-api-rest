package com.louzao.application.domain.model.config.primary;
...
@EnableJpaRepositories(
    basePackages = {
        "com.louzao.application.domain.model.domain.mssql.autoline",
        "com.louzao.application.domain.ports.secondary.repository.mssql.autoline"},
