...
@Table(name = DbTables.VW_INPUT_VAT_CONCILIATION)
@Data
@EqualsAndHashCode
@ToString
@SuperBuilder
...
public class InputVatConciliationEntity extends BaseEntity implements Serializable {

  private static final long serialVersionUID = 2360297212307475311L;
