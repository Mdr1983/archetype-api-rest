package com.mdemanuel.application.domain.model.config.primary;
...
@EnableJpaRepositories(
    basePackages = {
        "com.mdemanuel.application.domain.model.domain.postgres",
        "com.mdemanuel.application.domain.ports.secondary.repository.postgres"},
