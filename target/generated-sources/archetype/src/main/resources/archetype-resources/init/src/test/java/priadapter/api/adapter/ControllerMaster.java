...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.priadapter.api.adapter;

import static io.restassured.RestAssured.given;
import static org.hamcrest.Matchers.equalTo;
import static org.hamcrest.Matchers.hasSize;
import static org.mockito.Mockito.when;
import ${package}.application.domain.ports.primary.dto.request.CategoryDataDto;
import ${package}.application.domain.ports.primary.dto.request.CategoryDto;
import ${package}.application.domain.ports.primary.dto.request.MetadataDto;
import ${package}.application.domain.service.master.MasterService;
import ${package}.priadapter.BaseIntegrationTest;
