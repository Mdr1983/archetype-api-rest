...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.${artifactId}.repository.postgres.audit;

import ${package}.application.domain.model.domain.postgres.audit.AuditEntryEntity;
import ${package}.application.domain.ports.secondary.repository.postgres.audit.AuditEntryRepository;
