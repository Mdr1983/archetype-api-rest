...
import ${package}.application.domain.model.domain.postgres.audit.AuditExitEntity;
import ${package}.application.domain.ports.secondary.repository.postgres.audit.AuditExitRepository;
