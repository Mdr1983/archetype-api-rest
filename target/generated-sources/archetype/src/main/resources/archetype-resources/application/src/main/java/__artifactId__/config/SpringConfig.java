...
import ${package}.${artifactId}.domain.service.util.SearchCriteriaDtoDeserializer;
import ${package}.${artifactId}.domain.service.util.SearchCriteriaDtoSerializer;
import ${package}.${artifactId}.domain.service.util.SearchCriteriaGroupDtoDeserializer;
import ${package}.${artifactId}.domain.service.util.SearchCriteriaGroupDtoSerializer;
