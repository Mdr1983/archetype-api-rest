...
import ${package}.${artifactId}.util.redis.CustomKeyPrefixSerializer;
...
public class RedisConfig extends CachingConfigurerSupport {
  ...
  @Value("${symbol_dollar}{spring.cache.redis.use-key-prefix:false}")
  private boolean useKeyPrefix;
  @Value("${symbol_dollar}{spring.cache.redis.use-prefix}")
