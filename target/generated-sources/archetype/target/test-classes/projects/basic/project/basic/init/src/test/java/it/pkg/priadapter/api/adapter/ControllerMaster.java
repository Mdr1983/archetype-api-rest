...
import it.pkg.application.domain.ports.primary.dto.request.CategoryDataDto;
import it.pkg.application.domain.ports.primary.dto.request.CategoryDto;
import it.pkg.application.domain.ports.primary.dto.request.MetadataDto;
import it.pkg.application.domain.service.master.MasterService;
import it.pkg.priadapter.BaseIntegrationTest;
