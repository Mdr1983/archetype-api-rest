package it.pkg.application.domain.model.config.primary;
...
@EnableJpaRepositories(
    basePackages = {
        "it.pkg.application.domain.model.domain.postgres",
        "it.pkg.application.domain.ports.secondary.repository.postgres"},
