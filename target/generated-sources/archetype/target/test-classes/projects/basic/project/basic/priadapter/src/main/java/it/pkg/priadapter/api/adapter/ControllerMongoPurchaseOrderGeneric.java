...
import it.pkg.application.domain.service.exceptions.ValidateJsonException;
import it.pkg.application.domain.service.purchase_order.PurchaseOrderGenericMongoService;
import it.pkg.application.util.aspect.LogExecution;
import it.pkg.application.util.json.JsonValidationSchema;
import it.pkg.application.util.json.JsonValidationSchema.TypeSchema;
...
@RestController("controllerMongoPurchaseOrderGeneric")
@RequestMapping(path = "/mongo/purchase_order/generic")
@Tag(name = "MongoPurchaseOrderGeneric")
public class ControllerMongoPurchaseOrderGeneric {

  @Autowired
  private JsonValidationSchema jsonValidationSchema;
  @Autowired
  private PurchaseOrderGenericMongoService purchaseOrderGenericMongoService;
  ...
  @ResponseBody
  @LogExecution
  public ResponseEntity<ApiResponseDto<List<GenericDto>>> getAllPurchaseOrder(HttpServletRequest request) {
    return new ResponseEntity<>(
        new ApiResponseDto<>(HttpStatus.OK.value(), HttpStatus.OK.getReasonPhrase(), request.getRequestURI(),
            purchaseOrderGenericMongoService.getAllPurchaseOrder()), HttpStatus.OK);
  }
  ...
  @ResponseBody
  @LogExecution
  public ResponseEntity<ApiResponseDto<Page<GenericDto>>> getAllPurchaseOrder(HttpServletRequest request,
    ...
    return new ResponseEntity<>(
        new ApiResponseDto<>(HttpStatus.OK.value(), HttpStatus.OK.getReasonPhrase(), request.getRequestURI(),
            purchaseOrderGenericMongoService.getAllPurchaseOrder(dto)), HttpStatus.OK);
  }
  ...
  @ResponseBody
  @LogExecution
  public ResponseEntity<ApiResponseDto<GenericDto>> getPurchaseOrder(HttpServletRequest request,
      @PathVariable String code)
      throws ItemNotFoundException {
    return new ResponseEntity<>(
        new ApiResponseDto<>(HttpStatus.OK.value(), HttpStatus.OK.getReasonPhrase(), request.getRequestURI(),
            purchaseOrderGenericMongoService.getPurchaseOrder(code)), HttpStatus.OK);
  }
  ...
  public ResponseEntity<ApiResponseDto> addPurchaseOrder(HttpServletRequest request,
    ...
    return new ResponseEntity<>(
        new ApiResponseDto<>(HttpStatus.CREATED.value(), HttpStatus.CREATED.getReasonPhrase(), request.getRequestURI(),
            purchaseOrderGenericMongoService.addPurchaseOrder(dto)), HttpStatus.CREATED);
  }
  ...
  public ResponseEntity<ApiResponseDto> updatePurchaseOrder(HttpServletRequest request,
    ...
    return new ResponseEntity<>(
        new ApiResponseDto<>(HttpStatus.OK.value(), HttpStatus.OK.getReasonPhrase(), request.getRequestURI(),
            purchaseOrderGenericMongoService.updatePurchaseOrder(dto, code)), HttpStatus.OK);
  }
  ...
  public ResponseEntity<ApiResponseDto> deletePurchaseOrder(HttpServletRequest request, @PathVariable String code)
      throws ItemNotFoundException {
    purchaseOrderGenericMongoService.deletePurchaseOrder(code);
