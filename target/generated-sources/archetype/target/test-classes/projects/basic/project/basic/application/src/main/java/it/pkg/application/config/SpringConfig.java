package it.pkg.application.config;
...
import it.pkg.application.domain.ports.primary.dto.request.SearchCriteriaDto.SearchCriteriaGroupDto;
import it.pkg.application.domain.service.util.SearchCriteriaDtoDeserializer;
import it.pkg.application.domain.service.util.SearchCriteriaDtoSerializer;
import it.pkg.application.domain.service.util.SearchCriteriaGroupDtoDeserializer;
import it.pkg.application.domain.service.util.SearchCriteriaGroupDtoSerializer;
