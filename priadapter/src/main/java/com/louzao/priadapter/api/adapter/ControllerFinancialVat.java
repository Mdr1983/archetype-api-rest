...
@RestController("controllerFiancialVat")
@RequestMapping(path = "/financial/vat")
@Tag(name = "Financial - VAT")
public class ControllerFinancialVat {

  @Autowired
  private VatService vatService;

  @GetMapping(value = "/input_vat/{company}/{year}/{month}", produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  public ResponseEntity<ApiResponseDto<List<InputVatDto>>> getInputVat(HttpServletRequest request,
      @PathVariable String company, @PathVariable Integer year, @PathVariable Integer month)
      throws ItemNotFoundException {
    return new ResponseEntity<>(
        new ApiResponseDto<>(HttpStatus.OK.value(), HttpStatus.OK.getReasonPhrase(), request.getRequestURI(),
            vatService.findInputVatByCompanyYearMonth(company, year, List.of(month))), HttpStatus.OK);
  }

  @GetMapping(value = "/output_vat/{company}/{year}/{month}", produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  public ResponseEntity<ApiResponseDto<List<OutputVatDto>>> getOutputVat(HttpServletRequest request,
    ...
    return new ResponseEntity<>(
        new ApiResponseDto<>(HttpStatus.OK.value(), HttpStatus.OK.getReasonPhrase(), request.getRequestURI(),
            vatService.findOutputVatByCompanyYearMonth(company, year, List.of(month))), HttpStatus.OK);
  }
  ...
  public ResponseEntity<ApiResponseDto<List<InputVatConciliationDto>>> getInputVatConciliation(
      HttpServletRequest request, @PathVariable String company, @PathVariable Integer year, @PathVariable Integer month)
      throws ItemNotFoundException {
    return new ResponseEntity<>(
        new ApiResponseDto<>(HttpStatus.OK.value(), HttpStatus.OK.getReasonPhrase(), request.getRequestURI(),
            vatService.findInputVatConciliationByCompanyYearMonth(company, year, List.of(month))), HttpStatus.OK);
  }

  @GetMapping(value = "/output_vat_conciliation/{company}/{year}/{month}", produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  public ResponseEntity<ApiResponseDto<List<OutputVatConciliationDto>>> getOutputVatConciliation(
    ...
    return new ResponseEntity<>(
        new ApiResponseDto<>(HttpStatus.OK.value(), HttpStatus.OK.getReasonPhrase(), request.getRequestURI(),
            vatService.findOutputVatConciliationByCompanyYearMonth(company, year, List.of(month))), HttpStatus.OK);
  }

  @GetMapping(value = "/vat_account_balance/{company}/{year}/{month}", produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  public ResponseEntity<ApiResponseDto<List<VatAccountBalanceDto>>> getVatAccountBalance(HttpServletRequest request,
    ...
    return new ResponseEntity<>(
        new ApiResponseDto<>(HttpStatus.OK.value(), HttpStatus.OK.getReasonPhrase(), request.getRequestURI(),
            vatService.findVatAccountBalanceByCompanyYearMonth(company, year, List.of(month))), HttpStatus.OK);
  }
}
