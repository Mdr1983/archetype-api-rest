...
@Repository
public class InputVatConciliationRepositoryImpl implements InputVatConciliationRepository {

  private static final String QUERY_FIND_BY_COMPANY_YEAR_MONTH = "SELECT * "
      + "FROM inf.vw_input_vat_conciliation "
  ...
  @Override
  public List<InputVatConciliationEntity> findByCompanyYearMonth(String company, Integer year, List<Integer> month) {
    try {
      ...
      return namedParameterJdbcTemplate.query(QUERY_FIND_BY_COMPANY_YEAR_MONTH, namedParameters,
          new BeanPropertyRowMapper<>(InputVatConciliationEntity.class));
